// SearchedWeatherCard.js

import React, {useState, useEffect} from 'react';
import {View, Text, Image} from 'react-native';
import {format} from 'date-fns';
import Icon from 'react-native-vector-icons/MaterialCommunityIcons';
import styles from './searchedWeatherCard.style';

const SearchedWeatherCard = ({searchResult, initialCityName}) => {
  const {name, weather, main, wind, visibility, sys} = searchResult;
...
export default SearchedWeatherCard;
